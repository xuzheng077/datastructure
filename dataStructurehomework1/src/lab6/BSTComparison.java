 ...
 * Lab 6 Comparing lab6.BST with Ordered Array and Linked List.
 * <p>
 * Andrew ID: xuzheng
 *
 * @author Xu Zheng
...
public class BSTComparison {
    ...
    /**
     * build a new lab6.BST with the minimum height inserting values in an ordered array recursively.
     *
     * @param theBST       lab6.BST data structure
     * @param orderedArray ordered array from which values to get and add into lab6.BST
     */
    ...
    /**
     * Recursive helper method to build lab6.BST with the minimum height.
     *
     * @param theBST lab6.BST data structure to build
     * @param array  array from which values to get and add into lab6.BST
    ...
    /**
     * Test program to compare lab6.BST with Array and LL.
     *
    ...
    public static void main(String[] args) {
        ...
        // build a lab6.BST with the values from the ordered array
        BST theBST = createMinBST(array);

        Stopwatch timer1 = new Stopwatch();
        theBST.find(VALUE_TO_SEARCH);
        System.out.println(" Search on lab6.BST search: " + timer1.elapsedTime() + " millisec");
        ...
        theBST.delete(0);
        System.out.println(" Delete on lab6.BST: " + timer4.elapsedTime() + " millisec");
        ...
        theBST.insert(0);
        System.out.println(" Insert on lab6.BST: " + timer7.elapsedTime() + " millisec");
